        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if (not hitsWall):
                ...
                if (newPos in state[1]):
                    ...
                    child = [newPos, cornersLeft]
                else:
                    child = [newPos, state[1]]
...
def cornersHeuristic(state, problem):
    ...
    while not len(cornersLeft) == 0:
        ...
        heuristic = heuristic + minDis

        pos = cornersLeft[distances.index(minDis)]
        cornersLeft.remove(pos)
